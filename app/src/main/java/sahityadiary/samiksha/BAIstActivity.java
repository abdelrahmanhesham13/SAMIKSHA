...
public class BAIstActivity extends AppCompatActivity implements SubjectAdapter.OnItemClick {
    ...
    private static final String subjectUrl = "https://sheets.googleapis.com/v4/spreadsheets/1mGueqTtAEXm-FZrYt4j69uQJGdPLyp6Q5_PRUA0KdzU/values/BA%201ST!A:E?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";
    private static final String topicUrl = "https://sheets.googleapis.com/v4/spreadsheets/1mGueqTtAEXm-FZrYt4j69uQJGdPLyp6Q5_PRUA0KdzU/values/BA%201ST%20TOPIC%20NAME!A:E?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_baist);
        setTitle("SAMIKSHA");
        ...
        topicsAdapter = new TopicsAdapter(topics, new TopicsAdapter.OnItemClick() {
            ...
            public void setOnItemClick(int position) {
                Intent intent = new Intent(BAIstActivity.this, NoteDetailsActivity.class);
                intent.putExtra("selectedTopicId", topics.get(position).getTopicId());
                intent.putExtra("Topic","BA1");
