...
public class BAIIndActivity extends AppCompatActivity implements SubjectAdapter.OnItemClick {
    ...
    private static final String subjectUrl = "https://sheets.googleapis.com/v4/spreadsheets/1mGueqTtAEXm-FZrYt4j69uQJGdPLyp6Q5_PRUA0KdzU/values/BA%202ND!A:F?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";
    private static final String topicUrl = "https://sheets.googleapis.com/v4/spreadsheets/1mGueqTtAEXm-FZrYt4j69uQJGdPLyp6Q5_PRUA0KdzU/values/BA%202ND%20TOPIC%20NAME!A:F?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_baiind);
        setTitle("SAMIKSHA");
        ...
        topicsAdapter = new TopicsAdapter(topics, new TopicsAdapter.OnItemClick() {
            ...
            public void setOnItemClick(int position) {
                Intent intent = new Intent(BAIIndActivity.this, NoteDetailsActivity.class);
                intent.putExtra("selectedTopicId", topics.get(position).getTopicId());
                intent.putExtra("Topic","BA2");
