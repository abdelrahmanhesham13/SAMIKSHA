...
public class BAIIIrdActivity extends AppCompatActivity implements SubjectAdapter.OnItemClick {
    ...
    private static final String subjectUrl = "https://sheets.googleapis.com/v4/spreadsheets/1mGueqTtAEXm-FZrYt4j69uQJGdPLyp6Q5_PRUA0KdzU/values/BA%203RD!A:F?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";
    private static final String topicUrl = "https://sheets.googleapis.com/v4/spreadsheets/1mGueqTtAEXm-FZrYt4j69uQJGdPLyp6Q5_PRUA0KdzU/values/BA%203RD%20TOPIC%20NAME!A:F?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_baiiird);
        setTitle("SAMIKSHA");
        ...
        topicsAdapter = new TopicsAdapter(topics, new TopicsAdapter.OnItemClick() {
            ...
            public void setOnItemClick(int position) {
                Intent intent = new Intent(BAIIIrdActivity.this, NoteDetailsActivity.class);
                intent.putExtra("selectedTopicId", topics.get(position).getTopicId());
                intent.putExtra("Topic","BA3");
            ...
            if (jsonResponse != null) {
                try {
                    ...
                    for (int i =5 ;i<subjects.size();i+=5){
                        subjects.add(i,new Subject("Empty", "Empty"));
                    }
                ...
                try {
                    ...
                    for (int i = 1; i < jsonArray.length(); i++) {
                        ...
                        if (topicStatue.equals("ACTIVE") && subjectId.equals(selectedSubjectId)) {
                            topics.add(new Topic(subjectId, subjectName, topicId, topicName, topicStatue));
                        }
                    }
                    for (int i =5 ;i<topics.size();i+=5){
                        topics.add(i,new Topic("Empty", "Empty","Empty","Empty","Empty"));
                    }
