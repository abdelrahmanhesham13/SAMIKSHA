...
public class MAFinalActivity extends AppCompatActivity implements SubjectAdapter.OnItemClick {
    ...
    private static final String subjectUrl = "https://sheets.googleapis.com/v4/spreadsheets/1mGueqTtAEXm-FZrYt4j69uQJGdPLyp6Q5_PRUA0KdzU/values/MA%20FINAL!A:F?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";
    private static final String topicUrl = "https://sheets.googleapis.com/v4/spreadsheets/1mGueqTtAEXm-FZrYt4j69uQJGdPLyp6Q5_PRUA0KdzU/values/MA%20FINAL%20TOPIC%20NAME!A:F?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topicsAdapter = new TopicsAdapter(topics, new TopicsAdapter.OnItemClick() {
            ...
            public void setOnItemClick(int position) {
                Intent intent = new Intent(MAFinalActivity.this, NoteDetailsActivity.class);
                intent.putExtra("selectedTopicId", topics.get(position).getTopicId());
                intent.putExtra("Topic","MAF");
